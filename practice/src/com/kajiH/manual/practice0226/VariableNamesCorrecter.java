package com.kajiH.manual.practice0226;
...
public class VariableNamesCorrecter {
        public static void main(String[] args) {
                ...
                ballpointPenSumPrice = (int) Math.round(
                                (ballpointPenPrice * ballpointPenNum)
                                                * salesTax);
                noteSumPrice = (int) Math.round(
                                (notePrice * noteNum) * salesTax);
                purchasePrice = ballpointPenSumPrice + noteSumPrice;
                System.out.printf("%12s: 1 個 %3d 円 × %1d 個 = %3d 円（税込）%n",
                                ballpointPenCode, ballpointPenPrice,
                                ballpointPenNum, ballpointPenSumPrice);
                System.out.printf("%12s: 1 個 %3d 円 × %1d 個 = %3d 円（税込）%n",
                                noteCode, notePrice, noteNum, noteSumPrice);
